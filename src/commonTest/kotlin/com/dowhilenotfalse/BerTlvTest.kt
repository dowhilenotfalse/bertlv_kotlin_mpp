...
class BerTlvTest {
    ...
    fun multibyteTagIsSupported() {
        val tag = Tag(BerTlv.bytes("9F02"), BerTlv.bytes("9F03069F1A02"))
    ...
    fun primitiveTagHasAValue() {
        val tag = Tag(BerTlv.bytes("0C"), BerTlv.bytes("4D7E6C6C6572"))
        val berTlv = BerTlv(tag.toString())
    ...
    fun tlvWithOnlyTagThrowsTagException(){
        ...
        assertEquals("9F9F9F", exception.tag.name)
